...
## 返回与给定字符串名字关联的类或者接口的Class对象    
        /**
         * Returns the {@code Class} object associated with the class or
         * interface with the given string name.  Invoking this method is
         * equivalent to:
         *
#### 等同于Class.forName(className, true, currentLoader)          
         * <blockquote>
         ...
         * the current class.
         *
##### 例如，下面代码片段返回java.lang.Thread的运行时Class描述符         
...
##### 需要注意该方法不去检查该请求类对于调用者是否可访问。      
         * Note that this method does not check whether the requested class
         * is accessible to its caller.
         *
##### 如果参数loader为null，并且存在一个安全管理器，调用者的类加载器不为null，那么，该方法会带着RuntimePermission("getClassLoader")权限 调用这个安全管理器的 checkPermission方法
##### 以保证它能够访问 启动类加载器。         
